...
export default function InstagramFeed() {
  return (
    <section className="section-wrapper bg-brand-black">
      <div className="max-w-content mx-auto">
        ...
        <AnimateOnScroll animation="fade-up" delay={300} className="text-center mt-8">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 h-11 px-6 rounded-full border border-grey-dark text-grey-med hover:text-white hover:border-primary/50 transition-all duration-200 font-body text-sm"
          >
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
